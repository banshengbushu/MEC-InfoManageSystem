...
public class CourseManage2
{
	...
	public CourseManage2()
	{
		this(null, null);
	}
	
	public CourseManage2(String userId, String userName)
	{
		initFrame(userName);
		reinitFrame();
		dealAction();
	...
	private void showCourseInfo(String id)
	{
		...
		ResultSet rs = null;
		String SQLString = "SELECT CourseName, MainName, HaveCourseTime, MaxNumber, SYS_INF_COURSE.TeacherId AS df, BookInStatus, CourseStatus, TeacherName, CoursePrice "
	...
	{	
		...
		String SQLString = "SELECT SYS_XTGL_SUBJECT.SubjectId, SubjectTime, MainName, SubjectName "
	...
	private void SelectMainName()
	{
		...
		String SQLString = "INSERT INTO SYS_INF_COURSE (CourseId, CourseNumber, ClassNumber, CourseName, MainName, HaveCourseTime, TeacherId, MaxNumber, BookInStatus, CourseStatus,CoursePrice) VALUES ('" +
				newId + "', '" + num  + "', '" + newId.substring(8,8+2)  + "', '" + courseName  + "', '" + name + "', '" + time  + "', '" + teacherId  + "', '" + max + "', '" + 1 + "', '" + 0 +"','"+selectOnSubjectInfo()+"')";
	...
	private int selectOnSubjectInfo()
	{		
		ArrayList<String> subjectId = new ArrayList<String>();
		int i = 0;
		ResultSet rs = null;
	...
	private void OnMainName()
	{
		...
		String SQLString = "INSERT INTO SYS_INF_COURSE (CourseId, CourseNumber, ClassNumber, CourseName, MainName, HaveCourseTime, TeacherId, MaxNumber, BookInStatus, CourseStatus,CoursePrice) "
				+ "	VALUES ('"+year+month+number+"01"+"', '"+number+"', '"+"01"+"', '"+year+"年"+month+"月"+inputName+"01"+"', '"+inputName+"', '未定', '"+new myData(jcbTeacher.getSelectedItem().toString(),"").subString(0, 0+4)+"', '"+jtfMaxNumbertxt.getText()+"', '1', '0','"+selectOnSubjectInfo()+"')";	
